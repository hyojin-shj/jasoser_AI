...
| :---: | :---: | :---: |
| ![similarity](https://via.placeholder.com/300x300?text=Similarity+Score) | ![topk](https://via.placeholder.com/300x300?text=Top-K+Sentences) | ![llm](https://via.placeholder.com/300x300?text=LLM+Feedback) |
